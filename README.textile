...
Right now, Quipkit builds as a basic game engine with some SDL, OpenGL and libpng bindings. It can build on Linux and Windows. Running it should show a yellow smiley face that bounces around until you close the window.
...
Then type @make@. Enter @./game@ to try it out.
