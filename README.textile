...
Right now, Quipkit builds a basic game engine with some SDL, OpenGL and libpng bindings. It can build on Linux and Windows. Running it should show a yellow character that continually walks down the screen.
