...
gamelets.stack:push(gamelets.get("my_gamelet"):new{ x = 1, y = 2 })
...
Next, get your gamelet and make a new instance of it, passing any options you need.
...
Finally, call gamelest.run() to run your game.
