...
If @event@, @update@ or @draw@ return any other value, it will be returned by the same method of @gamelet.stack@. For example, if you're using "game.lua":game.textile, returning @game.REDRAW@ prompts a redraw of the game screen, while returning @game.QUIT@ ends the game loop.
