...
Render text to a new sprite using a TrueType font loaded with a function like @SDL.TTF_OpenFont@. The color should be a table of the form @{red, green, blue}@, where each entry is a number from 0 to 255.
